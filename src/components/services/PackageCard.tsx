...
export function PackageCard({ item, selected, onSelect }: { item: Package; selected?: boolean; onSelect?: () => void }) {
  return <button onClick={onSelect} className={cn("pressable relative w-full rounded-[22px] border bg-white p-5 text-left", selected ? "border-[#2FA084] bg-[#fbffef] shadow-[0_10px_24px_rgba(31,111,95,.08)] ring-2 ring-[#FFE394]" : "border-[#D8DEDA] hover:border-[#cad7d2]")}>
