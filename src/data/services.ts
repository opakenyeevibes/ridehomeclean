...
export const services: Service[] = [
  make({ id: "home-cleaning", name: "Home Care", shortName: "Home Care", styleKey: "home", startingPrice: 75000, duration: "2–3 jam", tagline: "Rumah rapi, nyaman, dan terawat", category: "Home Care", description: "Layanan bersih rumah panggilan dari Ride N Care. Partner datang ke lokasi kamu untuk membantu rumah terasa lebih rapi, bersih, dan nyaman." }),
  ...
  make({ id: "custom", name: "Custom Care", shortName: "Custom", styleKey: "custom", startingPrice: 50000, duration: "Sesuai kebutuhan", tagline: "Care yang mengikuti kebutuhanmu", category: "Premium Care", description: "Ceritakan kebutuhan khususmu dan tim Ride N Care akan membantu menyusun ruang lingkup layanan yang paling sesuai." }),
];
